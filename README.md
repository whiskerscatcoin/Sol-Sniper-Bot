...
1. Download and extract the repository files: Use the command "git clone https://github.com/AhmedRabby2002/Solana-Raydium-Sniper-Bot.git" or click the green "Code" button and select "Download ZIP".
